...
export class SquareShape extends Component {

  render() {
    return (
      <svg width="100" height="100">
        <rect width="90" height="90" x="5" y="5" fill="#ddd" />
      </svg>
    )
  }
}
...
export class CircleShape extends Component {
  ...
  render() {
    return (
      <svg width="100" height="100">
        <circle cx="50" cy="50" r="47.5" fill="#ddd" />
      </svg>
    )
  }
}
...
export class BadgeShape extends Component {
  ...
  render() {
    return (
      <svg width="100" height="100">
        <polygon fill="#DDDDDD" points="49.384,6.384 56.54,4.203 62.671,8.489 70.152,8.625 74.659,14.597 81.731,17.038 84.171,24.109 
...
export class LabelShape extends Component {
  
  render() {
    return (
      <svg width="100" height="100">
        <path fillRule="evenodd" clipRule="evenodd" fill="#DDDDDD" d="M96.764,50.208c-0.002,3.772,0,7.544-0.002,11.316
